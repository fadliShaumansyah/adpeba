...
<h2>INPUT DATA PIMPINAN JAMAAH
  ...
  @endif
    ...
    <form action="/daftarpj/post" method="post">
        @csrf
        <input  placeholder="Name" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 dark:focus:text-white focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
          ...
          <div class="relative">
            ...
            >
              <div class="flex items-center justify-between px-5">
                <button
                  id="prevMonth"
                  class="rounded-md px-2 py-2 text-dark hover:bg-gray-2 dark:text-black dark:hover:bg-dark"
                >
                  <svg
                    class="fill-current"
                    width="20"
                ...
                <div
                  id="currentMonth"
                  class="text-lg font-medium text-dark-3 dark:text-black"
                ></div>
                <button
                  id="nextMonth"
                  class="rounded-md px-2 py-2 text-dark hover:bg-gray-2 dark:text-black dark:hover:bg-dark"
              ...
              >
                ...
                <button
                  id="applyButton"
                  class="rounded-lg border border-primary bg-primary px-5 py-2.5 text-base font-medium text-primary hover:text-white hover:bg-[#1B44C8]"
                >
                  Apply
                </button>
              </div>
