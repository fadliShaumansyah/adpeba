                            ...
                            <div class="flex flex-col flex-grow p-4 overflow-auto">
                                ...
                                @auth
                                    @if(Auth::user()->role === 'admin' || Auth::user()->role === 'super_admin')
                                        <a class="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-300" href="{{ route ('silatsuta') }}">
                                            
                                        <span class="leading-none">Silat Suta</span>
                                        </a>
