...
<div class="flex flex-col w-56 border-r border-gray-300 z-0">
                            ...
                            <div class="flex flex-col flex-grow p-4 ">
                                ...
                                @auth
                                    @if(Auth::user()->role === 'admin' || Auth::user()->role === 'super_admin')
                                        ...
                                        <span class="leading-none">Pesat</span>
                                        </a>
                                        <a class="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-300" href="#">
                                        <span class="leading-none">Persada</span>
                                        </a>
                                        <a class="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-300" href="#">
                                        <span class="leading-none">Futsal</span>
                                        </a>
                                        <a class="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-300" href="#">
                                        <span class="leading-none">Atlit</span>
                                        </a>
                                ...
                                <a class="z-0 flex items-center flex-shrink-0 h-10 px-3 mt-auto text-sm font-medium bg-gray-200 rounded hover:bg-gray-300"
                                    href="#">
